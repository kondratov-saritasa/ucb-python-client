...
class OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity(object):
    ...
    swagger_types = {
        ...
        'pre_build_script_fails_build': 'bool',
        'post_build_script_fails_build': 'bool',
    ...
    attribute_map = {
        ...
        'pre_build_script_fails_build': 'preBuildScriptFailsBuild',
        'post_build_script_fails_build': 'postBuildScriptFailsBuild',
    ...
    def __init__(self, pre_export_method=None, post_export_method=None, pre_build_script=None, post_build_script=None, pre_build_script_fails_build=None, post_build_script_fails_build=None, scripting_define_symbols=None, player_exporter=None, player_settings=None, editor_user_build_settings=None, asset_bundles=None, addressables=None, run_unit_tests=None, run_edit_mode_tests=None, run_play_mode_tests=None, failed_unit_test_fails_build=None, unit_test_method=None, enable_light_bake=None):  # noqa: E501
        ...
        self._pre_build_script_fails_build = None
        self._post_build_script_fails_build = None
        ...
        if pre_build_script_fails_build is not None:
            self.pre_build_script_fails_build = pre_build_script_fails_build
        if post_build_script_fails_build is not None:
            self.post_build_script_fails_build = post_build_script_fails_build
    ...
    @property
    def pre_build_script_fails_build(self):
        """Gets the pre_build_script_fails_build of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity.  # noqa: E501

        If this is true, a non-zero exit code on your preBuildScript will cause your build to be marked as Failed  # noqa: E501

        :return: The pre_build_script_fails_build of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity.  # noqa: E501
        :rtype: bool
        """
        return self._pre_build_script_fails_build

    @pre_build_script_fails_build.setter
    def pre_build_script_fails_build(self, pre_build_script_fails_build):
        """Sets the pre_build_script_fails_build of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity.

        If this is true, a non-zero exit code on your preBuildScript will cause your build to be marked as Failed  # noqa: E501

        :param pre_build_script_fails_build: The pre_build_script_fails_build of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity.  # noqa: E501
        :type: bool
        """

        self._pre_build_script_fails_build = pre_build_script_fails_build

    @property
    def post_build_script_fails_build(self):
        """Gets the post_build_script_fails_build of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity.  # noqa: E501

        If this is true, a non-zero exit code on your postBuildScript will cause your build to be marked as Failed  # noqa: E501

        :return: The post_build_script_fails_build of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity.  # noqa: E501
        :rtype: bool
        """
        return self._post_build_script_fails_build

    @post_build_script_fails_build.setter
    def post_build_script_fails_build(self, post_build_script_fails_build):
        """Sets the post_build_script_fails_build of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity.

        If this is true, a non-zero exit code on your postBuildScript will cause your build to be marked as Failed  # noqa: E501

        :param post_build_script_fails_build: The post_build_script_fails_build of this OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnity.  # noqa: E501
        :type: bool
        """

        self._post_build_script_fails_build = post_build_script_fails_build
