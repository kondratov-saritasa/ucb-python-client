...
class UserdevicesApi(object):
    ...
    def create_device(self, options, **kwargs):  # noqa: E501
        """Create iOS device profile  # noqa: E501

        Create iOS device profile for the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_device(options, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_device_with_http_info(options, **kwargs)  # noqa: E501
        else:
            (data) = self.create_device_with_http_info(options, **kwargs)  # noqa: E501
            return data

    def create_device_with_http_info(self, options, **kwargs):  # noqa: E501
        """Create iOS device profile  # noqa: E501

        Create iOS device profile for the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_device_with_http_info(options, async_req=True)
        >>> result = thread.get()
    ...
    def list_devices_for_user(self, **kwargs):  # noqa: E501
        """List iOS device profiles  # noqa: E501

        List all iOS device profiles for the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_devices_for_user(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_devices_for_user_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_devices_for_user_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_devices_for_user_with_http_info(self, **kwargs):  # noqa: E501
        """List iOS device profiles  # noqa: E501

        List all iOS device profiles for the current user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_devices_for_user_with_http_info(async_req=True)
        >>> result = thread.get()
